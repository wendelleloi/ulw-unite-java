...
public class EventController {
    ...
    public ResponseEntity<AttendeeIdDTO> createEvent(@PathVariable String eventId, @RequestBody AttendeeRequestDTO body, UriComponentsBuilder uriComponentsBuilder){
